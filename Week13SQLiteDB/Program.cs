...
static void FindCustomer(SQLiteConnection myConnection)
{
    ...
    Console.WriteLine("Enter the first name of the customer you want to find:");
    ...
    command = myConnection.CreateCommand();
    command.CommandText = $"SELECT rowid, * FROM customer WHERE firstName = @FirstName AND lastName = @LastName";
